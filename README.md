...
"code/HOI_0_wrapper.R" - calls all the following scripts in order (ordered by their name and runned accordingly). 
...
"code/HOI_3_Function_fit_alpha_r.R" - contains the functions which extract the Omega, centroid, theta, feasibility domaine. 
